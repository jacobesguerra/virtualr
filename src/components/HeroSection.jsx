  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
            ...
            our intuitive development tools. Get started today and turn your imagination into   
            immersive reality!
        </p>
        ...
        <div className="flex md:flex-row flex-col mt-10 justify-center items-center">
            <video  loop muted className="rounded-lg w-full md:w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4">
                <source src={video1} type="video/mp4"/>
                Your browser does not supper the video tag
            </video>
            <video  loop muted className="rounded-lg w-full md:w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4">
